...
func (o *DeleteImageOK) Error() string {
	return fmt.Sprintf("[DELETE /images/{itemId}][%d] deleteImageOK  %+v", 200, o.Payload)
}
...
func (o *DeleteImageBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /images/{itemId}][%d] deleteImageBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteImageNotFound) Error() string {
	return fmt.Sprintf("[DELETE /images/{itemId}][%d] deleteImageNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteImageDefault) Error() string {
	return fmt.Sprintf("[DELETE /images/{itemId}][%d] deleteImage default  %+v", o._statusCode, o.Payload)
}
