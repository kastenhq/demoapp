...
func (o *GetImageOK) Error() string {
	return fmt.Sprintf("[GET /images/{itemId}][%d] getImageOK  %+v", 200, o.Payload)
}
...
func (o *GetImageBadRequest) Error() string {
	return fmt.Sprintf("[GET /images/{itemId}][%d] getImageBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetImageNotFound) Error() string {
	return fmt.Sprintf("[GET /images/{itemId}][%d] getImageNotFound  %+v", 404, o.Payload)
}
...
// NewGetImageConflict creates a GetImageConflict with default headers values
func NewGetImageConflict() *GetImageConflict {
	return &GetImageConflict{}
}

/*GetImageConflict handles this case with default header values.

General Error
*/
type GetImageConflict struct {
	Payload *models.ErrorDetail
}

func (o *GetImageConflict) Error() string {
	return fmt.Sprintf("[GET /images/{itemId}][%d] getImageConflict  %+v", 409, o.Payload)
}

func (o *GetImageConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetImageDefault) Error() string {
	return fmt.Sprintf("[GET /images/{itemId}][%d] getImage default  %+v", o._statusCode, o.Payload)
}
