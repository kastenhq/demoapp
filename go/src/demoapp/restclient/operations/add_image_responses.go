...
func (o *AddImageCreated) Error() string {
	return fmt.Sprintf("[POST /images][%d] addImageCreated  %+v", 201, o.Payload)
}
...
func (o *AddImageBadRequest) Error() string {
	return fmt.Sprintf("[POST /images][%d] addImageBadRequest  %+v", 400, o.Payload)
}
...
func (o *AddImageConflict) Error() string {
	return fmt.Sprintf("[POST /images][%d] addImageConflict  %+v", 409, o.Payload)
}
...
func (o *AddImageDefault) Error() string {
	return fmt.Sprintf("[POST /images][%d] addImage default  %+v", o._statusCode, o.Payload)
}
